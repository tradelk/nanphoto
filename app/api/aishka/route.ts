...
2. Формат ответа:
   ...
   - Используй Markdown для структуры (заголовки, списки). Таблицы НЕ используй — любое табличное или сравнительное содержание выводи короткими тезисами (маркированные пункты).
...
3. Адаптивный формат по типу запроса:
   ...
   - Сравнения (А vs Б) → Короткие тезисы по критериям, без таблиц (маркированный список)
